...
export default function PoliticaPrivacidade(props) {
  ...
  return (
    <>
      <Layout>
        <Head>
          <title>Política de Privacidade e Proteção de Dados{SEO_TITLE}</title>
        </Head>

        <section className="md:pt-14 pt-24">
          <Container>
            <h1 className="md:typ-text-2 text-2xlMax text-green-dark">{page.Sec1Title}</h1>
          </Container>
        </section>
        ...
        <section>
          <Container>
            <h1 className="md:typ-text-2 text-2xlMax text-green-dark">{page.Sec2Title}</h1>
          </Container>
        </section>
        ...
        <section className="md:py-24 py-14">
          <Container>
            <div className="w-full flex">
              <div className="md:w-3/12"></div>
              <div className="md:w-9/12 w-full">
                <article className="typ-p text-gray-dark leading-relaxed"><Markdown>{page.Sec2Texto}</Markdown></article>
                ...
                <article className="typ-p text-gray-dark leading-relaxed mt-8">
                  <p>
                    Se você tiver perguntas adicionais ou precisar de mais
                    informações sobre nossa Política de Proteção de Dados, não
                    hesite em nos contatar através do e-mail:{" "}
                    <a
...
export async function getStaticProps() {
  const page = await getPage('page-politica-de-privacidade')
