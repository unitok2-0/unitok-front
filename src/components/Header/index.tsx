...
export function Header(props: HeaderProps) {
  ...
  return (
    <HeaderContainer {...headerProps}>
      {variant === "logoOnly" ? (
        <HeaderContent>
          <HeaderLogo heightLogo={heightLogo} widthLogo={widthLogo} />
        </HeaderContent>
      ) : (
        <>
          <HeaderContent>
            <HeaderLogo heightLogo={heightLogo} widthLogo={widthLogo} />
            {variant === "page" && <Pageheader pageIndex={whatPage} color={handleChangeColor()} />}
          </HeaderContent>
          {variant === "page" && <PageDiv color={handleChangeColor()} setOppenedBurguerMenu={props.setOppenedBurguerMenu} />}
