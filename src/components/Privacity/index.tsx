...
const termsPrivacity = [
  {
    ...
    content:
      <S.PrivacyTopicArea>
        ...
        <Text>
          O envio de e-mail marketing será feito apenas com a sua permissão. Nesses e-mails, você poderá receber notícias sobre o Unitok, novos serviços, conteúdos e outras atualizações.
        </Text>
      </S.PrivacyTopicArea>,
  },
  {
  ...
  },
  {
    ...
    content:
      <S.PrivacyTopicArea>
        ...
        <Text style={{ marginBottom: 28 }}>
          Dados pessoais do cliente: (i) nome; (ii) e-mail; (iii) endereço; (iv) telefone; (v) CPF; (vi) profissão; (vii) redes sociais.
        </Text>
        <Text color='primary' style={{ marginBottom: 28 }}>
          3.2. Finalidade do tratamento
        </Text>
        <Text style={{ marginBottom: 28 }}>
          3.2.1. Você fornece os seus dados para o cadastro em sistemas internos.
        </Text>
        <Text style={{ marginBottom: 28 }}>
          3.2.2. Você fornece seus dados para utilização, compartilhamento, criação e produção do seu cartão Unitok.
        </Text>
        <Text style={{ marginBottom: 28 }}>
          3.2.3. Para que o contato entre você e o Unitok possa ser feito.
        </Text>
        <Text color='primary' style={{ marginBottom: 28 }}>
