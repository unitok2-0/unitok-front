...
export function ProfileBanner({ }: ProfileBannerProps) {

  const [updatingImage, setUpdatingImage] = useState(false)

  const bannerModal = useDisclosure(false)
  const { user, deleteProfileBanner } = useAuth()
  ...
  return (
    <>
      <Container>
        <BannerContainer
          background_url={user?.bannerUrl || "/assets/unitok_logo_banner_profile.svg"}
          className='background-container'
          id="bannerUpdateProfile"
        >
