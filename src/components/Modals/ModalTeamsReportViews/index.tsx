...
interface ModalTeamsReportViews {
  modalIsOpen: boolean;
  closeModal: () => void;
...
export function ModalTeamsReportViews({modalIsOpen, closeModal, groups}: ModalTeamsReportViews) {
        ...
        Fechar
          ...
          {viewActive === "users"
            ? <UsersAdminstrationContainer 
                ...
                noPagination={true}
              />
            : <EnterpriseGroupsContainer admin={user} typeView="views"/>
          }
      </S.Wrapper>
    </>
  )
